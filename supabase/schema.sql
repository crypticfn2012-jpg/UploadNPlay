...
-- Existing games created before moderation existed remain visible only if they are
-- explicitly approved. Set any old games you trust to approved manually.
...
create policy "Developers can update their pending games"
